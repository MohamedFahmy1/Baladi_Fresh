    ...
    <Layout header={1}>
        ...
        <div className="container">
          ...
          <div className="section-title text-center mb-60">
            ...
            <p style={{ textAlign: "justify", fontSize: "18px" }}>
              ...
              premium-quality seasonings that elevate every meal with rich,
              natural aromas. With a growing network of stores, we are
              transforming the fresh food market in Qatar, providing a
              farm-to-table experience that brings fresh food right to your
              doorstep.
            </p>
          </div>
          <hr />
          <div className="category-wrap">
            <div className="category-item wow fadeInUp delay-0-3s">
              <div className="icon">
                <img
                  src="assets/baladi-imgs/1. Home Page/Category Icons/Vegetables and Fruits.svg"
                  alt="Icon"
                />
              </div>

              <h5>
                <Link href="/services">Fresh Fruites and Vegetable</Link>
              </h5>
            ...
            <div className="category-item wow fadeInUp delay-0-4s">
              <div className="icon">
                <img
                  src="assets/baladi-imgs/1. Home Page/Category Icons/Dairy.svg"
                  alt="Icon"
                />
              </div>
              <h5>
            ...
            <div className="category-item wow fadeInUp delay-0-5s">
              <div className="icon">
                <img
                  src="assets/baladi-imgs/1. Home Page/Category Icons/Meat and Poultry.svg"
                  alt="Icon"
                />
              </div>
              <h5>
                <Link href="/services">Meat and Poultry</Link>
              </h5>
              <img src="assets/images/category/arrow.png" alt="Arrow" />
            </div>
            <div className="category-item wow fadeInUp delay-0-6s">
              <div className="icon">
                <img
                  src="assets/baladi-imgs/1. Home Page/Category Icons/Spices.svg"
                  alt="Icon"
                />
              </div>
              <h5>
                <Link href="/services">Spices and Condiments</Link>
              </h5>
              <img src="assets/images/category/arrow.png" alt="Arrow" />
            </div>
            <div className="category-item wow fadeInUp delay-0-7s">
              <div className="icon">
                <img
                  src="assets/baladi-imgs/1. Home Page/Category Icons/Bakery.svg"
                  alt="Icon"
                />
              </div>
              <h5>
                <Link href="/services">Bakery Products</Link>
              </h5>
              <img src="assets/images/category/arrow.png" alt="Arrow" />
            </div>
          </div>
      ...
      <section className="offer-banners-area">
        <div className="container-fluid">
          ...
          >
            The Baladi Fresh Promise !!
          </h2>
          <div className="row justify-content-center">
            <div className="col-xl-4 col-md-6">
              <div
                style={{ borderRadius: "30px" }}
                className="offer-banner-item color-two wow fadeInUp delay-0-2s "
              >
                <div className="content">
                  {/* <span className="sub-title">35% Off Foods</span> */}
                  <h4 style={{ paddingInlineEnd: "5px" }}>
                    Freshness Guaranteed
                  </h4>
                  <p>
                    At Baladi Fresh, we are committed to delivering the freshest
                    products to you daily by working closely with local farms
                    and trusted suppliers. Our strict quality control processes
                    and fast delivery guarantee the best ingredients for every
                    meal.
                  </p>
            ...
            <div className="col-xl-4 col-md-6">
              ...
              >
                <div className="content">
                  ...
                  <p>
                    We offer a wide range of products, including fresh produce,
                    dairy, meats, fish, spices, bakery items, and pantry
                    staples. With options for every taste and preference, we
                    make it easy to find everything you need in one convenient
                    place.
                  </p>
                  {/* <p>Best Foods For Your Family</p> */}
                  {/* <Link href="/shop-grid">
            ...
            <div className="col-xl-4 col-md-6">
              ...
              >
                <div className="content">
                  ...
                  <p>
                    Our reliable home delivery service ensures quick and
                    efficient grocery deliveries across Qatar. With an easy
                    ordering system, we make shopping hassle-free and deliver
                    fresh essentials right to your doorstep on time.
                  </p>
                  {/* <p>Best Foods For Your Family</p> */}
                  {/* <Link href="/shop-grid">
                    <a className="theme-btn style-two">
            ...
            <div className="col-xl-4 col-md-6">
              ...
              >
                <div className="content">
                  ...
                  <p>
                    We take pride in our custom spice packaging line, adding
                    significant value to our offerings. Our carefully curated
                    selection of spices is processed and packaged in-house,
                    ensuring premium-grade seasonings and rich flavor in every
                    dish.
                  </p>
                  {/* <p>Best Foods For Your Family</p> */}
                  {/* <Link href="/shop-grid">
